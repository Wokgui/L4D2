...
module.exports=async function(req,res){
  ...
  try{
    ...
    const savedAt=new Date().toISOString(),content=Buffer.from(JSON.stringify({savedAt,campaigns:body.campaigns,otherCampaigns:body.otherCampaigns},null,2)).toString("base64");
