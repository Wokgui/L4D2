const CACHE="catalogue-l4d2-20260815-96";
const SHELL=["/","/app.js?v=20260813-82","/polish.css?v=20260813-81","/layout-air-v80.css?v=20260814-95","/bootstrap-data.js?v=20260810-3","/ui-patch-v88.js?v=20260814-97","/ui-patch-v91.js?v=20260815-104","/ui-patch-v93.js?v=20260815-5","/campaign-icon.jpg","/welcome-cover.png","/l4d2-final-192-v52.png","/l4d2-splash-512-v96.png","/steam-icon.png","/manifest.webmanifest?v=20260815-96","/cloud-backup.js?v=3","/vendor/supabase/supabase.js?v=1"];
const CACHE_FIRST_PATHS=new Set(["/welcome-cover.png","/campaign-icon.jpg","/l4d2-final-192-v52.png","/l4d2-splash-512-v96.png","/steam-icon.png"]);
