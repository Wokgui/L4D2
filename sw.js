const CACHE="catalogue-l4d2-20260913-126";
const SHELL=["/","/app.js?v=20260813-82","/polish.css?v=20260823-99","/layout-air-v80.css?v=20260825-108","/bootstrap-data.js?v=20260810-3","/ui-patch-v84.js?v=20260820-92","/ui-patch-v88.js?v=20260913-126","/ui-patch-v92.js?v=20260913-126","/ui-patch-v93.js?v=20260815-5","/ui-patch-v96.js?v=20260913-126","/ui-patch-v97.js?v=20260823-1","/ui-patch-v98.js?v=20260913-126","/campaign-icon.jpg","/welcome-cover.png","/l4d2-final-192-v52.png","/l4d2-splash-safe-512-v101.png?v=20260823-101","/l4d2-maskable-512-v53.png?v=20260823-105","/steam-icon-exact-v124.svg","/manifest.webmanifest?v=20260823-105","/cloud-backup.js?v=3","/secure-github-save.js?v=1","/vendor/supabase/supabase.js?v=1"];
...
self.addEventListener("fetch",event=>{
  ...
  if(sameOrigin(request)&&LEGACY_STEAM_ICONS.has(new URL(request.url).pathname)){
    const target=new Request(new URL("/steam-icon-exact-v124.svg",self.location.origin));
    event.respondWith(
