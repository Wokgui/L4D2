export default async function middleware(request) {
  ...
  if(path==='/'){
    ...
    html=html.replace('</body>','<script src="/ui-patch-v84.js?v=20260813-84"></script><script src="/ui-patch-v85.js?v=20260813-85"></script><script src="/ui-patch-v87.js?v=20260813-87"></script></body>');
